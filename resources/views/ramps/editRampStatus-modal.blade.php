            ...
            <div class="modal-body">
                <form action="<?= route('update.ramp.status') ?>" method="post" id="edit-ramp-status-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name"placeholder="Oznaczenie rampy" disabled>
                        <span class="text-danger error-text name_error"></span>
                    </div>
                    <div class="form-group">
                        <label for="">Status</label>
                        <select id="status" class="form-control" name="status">
                            <option  name="status" value="">Wybierz status z listy</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="power" class="form-control" name="power">
                            <option name="power" value="">Wybierz z listy</option>
